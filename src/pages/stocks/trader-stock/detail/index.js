...
export default connect(({ loading }) => ({ loading }), { getTrader })(
    ...
    return (
      <div className={styles['detail-style']}>
        <div className={styles['detail-item']}>
          ...
          <div className={styles['detail-content']}>{stockDetail['title']}</div>
        </div>
        <div className={styles['detail-item']}>
          <div className={styles['detail-title']}>
          ...
          <div className={styles['detail-content']}>{traderTime}</div>
        </div>
        <div className={styles['detail-item']}>
          <div className={styles['detail-title']}>
          ...
          <div className={styles['detail-content']}>{stockDetail['news']}</div>
        </div>
        <div className={styles['detail-item']}>
          <div className={styles['detail-title']}>
