...
export default connect(
  ...
  function onAdd() {
    history.push('/stocks/trader-stock/add');
  }
  ...
  function onEdit(record) {
    ...
    return history.push(`/stocks/trader-stock/edit?${qsString(params)}`);
  }
  ...
  function onDetail(record) {
    ...
    return history.push(`/stocks/trader-stock/detail?${qsString(params)}`);
  }
