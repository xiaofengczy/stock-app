    ...
    <div className={styles['detail-style']}>
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <AimOutlined style={{ marginRight: 6 }}/>名字:
        </div>
      ...
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <ClockCircleOutlined style={{ marginRight: 6 }}/>股票代码:
        </div>
        <div className={styles['detail-content']}>
          {stockDetail['code']}
        </div>
      ...
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}><AppstoreOutlined style={{ marginRight: 6 }}/>所属板块:</div>
        <div className={styles['detail-content']}>
          {stockDetail['plate']}
        </div>
      </div>
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <GithubOutlined style={{ marginRight: 6 }}/>股性分析:
        </div>
        <div className={styles['detail-content']}>
