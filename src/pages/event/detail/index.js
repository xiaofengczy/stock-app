...
(function Index(props) {
  ...
  useEffect(() => {
    ...
    getEvent(params).then(resp => {
      ...
      setCreateTie(moment(resp.data['createTime']).format('YYYY-MM-DD').toString());
    });
  }, []);
    ...
    <div className={styles['detail-style']}>
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <AimOutlined style={{ marginRight: 6 }}/>事件驱动:
        </div>
      ...
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <ClockCircleOutlined style={{ marginRight: 6 }}/>事件分析:
        </div>
        <div className={styles['detail-content']}>
      ...
      <div className={styles['detail-item']}>
        <div className={styles['detail-title']}>
          <ClockCircleOutlined style={{ marginRight: 6 }}/>利好个股:
        </div>
        <div className={styles['detail-content']}>
